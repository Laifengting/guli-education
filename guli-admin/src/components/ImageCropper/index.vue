	...
	<div class="vue-image-crop-upload" v-show="value">
		<div class="vicp-wrap">
			...
			<div class="vicp-step1" v-show="step == 1">
				<div @click="handleClick" @dragenter="preventDefault" @dragleave="preventDefault" @dragover="preventDefault"
					 @drop="handleChange" class="vicp-drop-area">
				...
				<div class="vicp-crop">
					<div class="vicp-crop-left" v-show="true">
						...
						<div class="vicp-range">
							<input :value="scale.range" @input="zoomChange" max="100" min="0" step="1" type="range">
							<i @mousedown="startZoomSub" @mouseout="endZoomSub" @mouseup="endZoomSub" class="vicp-icon5"/>
							<i @mousedown="startZoomAdd" @mouseout="endZoomAdd" @mouseup="endZoomAdd" class="vicp-icon6"/>
						</div>
